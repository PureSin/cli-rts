...
- [x] **1. Initialize Node.js project**
...
- [x] **2. Implement `cli-rts init`** (`src/commands/init.ts`)
...
- [x] **3. Implement `cli-rts emit <event-type>`** (`src/commands/emit.ts`)
...
- [x] **4. Implement `cli-rts start`** (`src/commands/start.ts`)
...
- [x] **5. Implement game state types** (`src/game-state.ts`)
...
- [x] **6. Implement event handlers** (`src/event-handlers.ts`)
