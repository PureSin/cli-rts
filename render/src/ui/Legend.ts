...
const TERRAIN_ENTRIES: { label: string; desc: string; fill: string; border: string }[] = [
...
const UNIT_ENTRIES: { shape: string; label: string; desc: string }[] = [
...
export class Legend {
  ...
  private makeHeader(text: string): HTMLDivElement {
  ...
  private makeSection(title: string, rows: HTMLElement[]): HTMLDivElement {
  ...
  private makeRow(swatch: HTMLElement, desc: string): HTMLDivElement {
  ...
  private makeTerrainSection(): HTMLDivElement {
  ...
  private makeUnitSection(): HTMLDivElement {
