...
let currentManifest = {
    ...
    version: "0.0.0",
    assets: {
        units: placeholderManifest.units,
        statusIndicators: placeholderManifest.statusIndicators
    }
};
...
export function createUnitGraphics(unitType, playerColor) {
...
export function createStatusIndicator(status, actionType) {
    ...
    let color = typeof manifestColor === 'string' ? parseInt(manifestColor, 16) : manifestColor;
